...
**Senior Software Engineer + DevOps Team Lead**  
*Location: remote in EU*

Designing and implementing a significant part of Roqad probabilistic identity graph solution.

Leading the migration effort during the acquisition of [Zeotap Data](https://zeotapdata.net/) and replatforming to [Ocient](https://ocient.com/).

**Tech stack:** Scala, Spark, Akka, Python/Luigi, Rust, Kubernetes

## 2014–2021: [Grid Dynamics](https://www.griddynamics.com/) + [Merkle](https://www.merkle.com/)

**Middle → Senior → Staff Software Engineer / Team Lead**  
*Location: Kharkiv, Ukraine → Kraków, Poland*

Designing and implementing a part of [Merkury](https://merkury.dentsu.com/) platform for a US-based performance marketing agency.
